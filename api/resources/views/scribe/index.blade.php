                ...
                <li class="tocify-item level-1" data-unique="tasks">
                    <a href="#tasks">Tasks</a>
                                    ...
                                    <ul id="tocify-subheader-tasks" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="tasks-GETapi-tasks-stats">
                                <a href="#tasks-GETapi-tasks-stats">Get task statistics</a>
                            </li>
...
<p>This API is not authenticated.</p>
    ...
    <p>APIs for managing tasks.</p>
                                ...
                                <h2 id="tasks-GETapi-tasks-stats">Get task statistics</h2>

<p>
</p>

<p>Returns task counts grouped by status and priority.</p>

<span id="example-requests-GETapi-tasks-stats">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/tasks/stats" \
...
<div class="javascript-example">
    ...
    "http://localhost/api/tasks/stats"
);
...
<span id="example-responses-GETapi-tasks-stats">
            <blockquote>
...
<span id="execution-results-GETapi-tasks-stats" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-tasks-stats"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-tasks-stats"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-tasks-stats" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-tasks-stats">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-tasks-stats" data-method="GET"
      data-path="api/tasks/stats"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-tasks-stats', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-tasks-stats"
                    onclick="tryItOut('GETapi-tasks-stats');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-tasks-stats"
                    onclick="cancelTryOut('GETapi-tasks-stats');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-tasks-stats"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-tasks-stats"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-tasks-stats"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>Creates a new task. Title is required, all other fields are optional with sensible defaults.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The task title. Max 100 characters. Example: <code>Implement user auth</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Add JWT authentication"
               data-component="body">
    <br>
<p>optional Task details. Max 500 characters. Example: <code>Add JWT authentication</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Task status. Allowed: pending, in_progress, completed. Example: <code>pending</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Task priority. Allowed: low, medium, high. Example: <code>high</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Due date in Y-m-d format. Example: <code>2026-05-01</code></p>
        </div>
        </form>
...
<p>Updates a task. Only send the fields you want to change.</p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Updated title. Max 100 characters. Example: <code>Updated title</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Updated status. Allowed: pending, in_progress, completed. Example: <code>completed</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>priority</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Updated priority. Allowed: low, medium, high. Example: <code>low</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>due_date</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="2026-04-08T17:44:02"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-04-08T17:44:02</code></p>
        </div>
        </form>
...
<p>Permanently deletes a task.</p>
